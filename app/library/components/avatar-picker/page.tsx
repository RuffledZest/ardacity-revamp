    ...
    <div className="container mx-auto px-6 py-8 max-w-6xl">
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <h1 className="text-4xl font-bold">Avatar Picker</h1>
          <Badge variant="secondary">Motion</Badge>
        </div>
        <p className="text-lg text-muted-foreground">
          An animated avatar picker component with smooth transitions and hover effects.
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Interactive preview of the Avatar Picker component</CardDescription>
            </div>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Install the Avatar Picker component using the shadcn/ui CLI</CardDescription>
        </CardHeader>
        <CardContent>
